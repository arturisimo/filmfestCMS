...
Lightbox.prototype = {
	...
	showElement: function(){
		var url = elementArray[activeElement][0];
		if(url.endsWith('swf') || (elementArray[activeElement][2]!='IMG')) { // SWF
			...
			//tratamiento de video streaming
			...
			//mp3
				...
				obj.innerHTML = "<object classid=\"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000\" codebase=\"http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0\" width=\""+elementArray[activeElement][2]+"\" height=\""+elementArray[activeElement][3]+"\">" +
					...
					"<embed wmode=\"transparent\" allowscriptaccess=\"always\" src=\""+url+"\" quality=\"high\"  pluginspage=\"http://www.macromedia.com/go/getflashplayer\" type=\"application/x-shockwave-flash\" width=\""+elementArray[activeElement][2]+"\" height=\""+elementArray[activeElement][3]+"\">" +
					"</embed>" +
					"</object>";
			}

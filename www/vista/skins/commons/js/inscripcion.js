/*	variables globales	*/
var goMsg = {};
var gcMsg_titulo = "> El t&iacute;tulo original es un campo obligatorio.<br>";
var gcMsg_nombre = "> El nombre de contacto es un campo obligatorio.<br>";
var gcMsg_email = "> El formato del email no es correcto.<br>";
var gcMsg_telefono = "> El telefono no es correcto.<br>";
var gcMsg_mensaje = "> La noticia es un campo obligatorio.<br>";
var gcMsg_director = "> El director es un campo obligatorio.<br>";
var gcMsg_pais = "> El pa&iacute;s es un campo obligatorio.<br>";
var gcMsg_ano = "> El a&ntilde;o es un campo obligatorio.<br>";
var gcMsg_duracion = "> La duraci&oacute;n es un campo obligatorio.<br>";
var gcMsg_sinopsis = "> La sinopsis es un campo obligatorio.<br>";
var gcMsg_tecnica = "> La ficha t&eacute;cnica es un campo obligatorio.<br>";
var gcMsg_web = "> La web no tiene un formato correcto.<br>";
var gcMsg_video = "> El enlace del v&iacute;deo no tiene un formato correcto.<br>";
var gcMsg_videovacio = "> Es necesario informar el enlace al v&iacute;deo en streaming.<br>";
var gcMsg_coste = "> El coste no es correcto<br>";
var gcMsg_formulario = "<strong>Oooops, el formulario no est&aacute; operativo todav&iacute;a. prueba a partir del lunes</strong>";
...
function cargarContacto(){
	ajax=nuevoAjax(); 
	ajax.open("POST", urlWWW + "inscripcion/contacto",true);
...
function cargarPelicula(){
	...
	ajax.open("POST",  urlWWW+"inscripcion/pelicula",true);
...
function cargarAdicional(){
	...
	ajax.open("POST", urlWWW + "inscripcion/adicional",true);
...
function cargarLicencia(licencia){
	...
	ajax.open("POST", urlWWW + "inscripcion/licencia",true);
...
function multimedia(){
	ajax=nuevoAjax();
	ajax.open("POST", urlWWW + "inscripcion/multimedia",true);
...
function _onLoad(){
	...
	Event.observe('b-contacto', 'click', function(e){
			...
			if (iNCampos > 0) {
				goMsg.nuevo('em', 'msg-info', "<strong>Revisa los siguientes errores:</strong> <br>");
			}
	...
	Event.observe('b-licencia', 'click', function(e){
			...
			if (licenciachecked==undefined) {
				bCorrecto = false;
				goMsg.nuevo('em', 'msg-info', "<strong>No has informado la licencia</strong> <br>");
			}
